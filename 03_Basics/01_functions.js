...
//     console.log(`The name of user is ${anyobject.username} and price ${anyobject.price}.`);
// }
...
// console.log(`The array is ${returnsecondvalue(myNewArray)}`);
// console.log(`The array is ${returnsecondvalue([353, 56, 76567, 765])}`);
